...
public class SearchFragment extends Fragment {
    ...
    public void view() {
        List<Trip> res=MakeTripFragment.tripDb.getTripsBySearch(origin.getText().toString(), destination.getText().toString(), day.getText().toString(), month.getText().toString(), seats.getText().toString());
        viewTrips(res);
